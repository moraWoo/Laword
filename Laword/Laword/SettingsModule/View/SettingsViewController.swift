...
class SettingsViewController: UIViewController, SettingsViewProtocol {
    ...
    let symbolCellRegistration =
    UICollectionView.CellRegistration<UICollectionViewListCell, SFSymbolItem> { (cell, _, symbolItem) in
    ...
    override func viewDidLoad() {
        ...
        dataSource =
        UICollectionViewDiffableDataSource<HeaderItem, SFSymbolItem>(
            collectionView: collectionView
        ) { [unowned self] (collectionView, indexPath, symbolItem) -> UICollectionViewCell? in
            ...
            if sections.title == "Внешний вид" {
                ...
                switchInCell.addTarget(
                    self,
                    action: #selector(launchAppWithOnboarding),
        ...
        <UICollectionViewListCell>(
            elementKind:
                UICollectionView.elementKindSectionHeader) { [unowned self] (headerView, _, indexPath) in
        ...
        <UICollectionViewListCell>(
            elementKind:
                UICollectionView.elementKindSectionFooter) { [unowned self] (footerView, _, indexPath) in
